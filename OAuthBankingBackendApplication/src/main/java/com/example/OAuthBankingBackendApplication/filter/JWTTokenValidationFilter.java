            ...
            try
            {
                ...
                if (env != null)
                {
                    ...
                    if (null != secretKey) {
                        ...
                        String username = String.valueOf(claims.get("username")); //simply converting object value to string
                        String authorities = String.valueOf(claims.get("authorities")); //simply converting object value to string
